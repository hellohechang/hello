~async function () {
  ...
  function handleLogin() {
    ...
    let str = `<main>
      <div class="account">
        <input autocomplete="off" type="text" value="${_getData("account") ? _getData("account") : ''}" placeholder="昵称/账号或邮箱">
      </div>
      <p class="paccount"></p>
      <div class="password">
  ...
  function handleResetPass() {
    ...
    $codebtn.click(debounce(function () {
  ...
  function handleRegister() {
    ...
    $submit.click(debounce(function () {
      let username = $username.val().trim(),
        ...
        email = $email.val().trim(),
        password = $password.val().trim();
      if (!checkUserName() || !checkUserEmail() || !checkCode() || !checkPassword()) return;
      validateImg.init(function () {
        _flag = true
        let npd = {
          username,
    ...
    $register.click(debounce(function () {
      validateImg.init(function () {
