...
route.post('/mergefile', async (req, res) => {
  try {
    ...
    await _rename(`${mediaurl.filepath}/tem/${HASH}/_hello`, `${mediaurl.filepath}/picys/${name}`)
    await mergefile(--count, `${mediaurl.filepath}/tem/${HASH}`, `${mediaurl.filepath}/pic/${name}`)
