~async function () {
  ...
  $from.text(`from ${musicobj.username}`)
  let showlrcfy = false,
    lrcstatu = _getData('lrcstatu') || { size: dmwidth > 768 ? 14 : 18, statu: 'center' };
  //歌词解析函数
  function musiclrc() {
  ...
  function proTime(pes, y) {
    ...
    let val = (pro1.offsetWidth - dolt.offsetWidth) * pes + dolt.offsetWidth / 2;
